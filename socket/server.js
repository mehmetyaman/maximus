...
try {
    ...
    if (config.get("autoRebootServerOnFailure") ) {
        autoRebootServerOnFailure = config.get("autoRebootServerOnFailure");
    }

    if (config.get("isUseHTTPs") ) {
        isUseHTTPs = config.get("isUseHTTPs");
    }
