...
window.RTCMultiConnection = function (roomid, forceOptions) {
    ...
    !function (connection) {
        ...
        mPeer.onGettingLocalMedia = function (stream) {
            ...
            parentNode.insertBefore(e.mediaElement, parentNode.firstChild), null, setTimeout(function () {
         //       e.mediaElement.play()
            }, 5e3)
            ...
            e && e.mediaElement && e.stream && ("both" === e.unmuteType || "video" === e.unmuteType ? (e.mediaElement.poster = null, e.mediaElement.src = URL.createOFbjectURL(e.stream), null) : "audio" === e.unmuteType && (e.mediaElement.muted = !1))
