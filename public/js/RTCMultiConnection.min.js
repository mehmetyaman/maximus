...
window.RTCMultiConnection = function (roomid, forceOptions) {
    function SocketConnection(connection, connectCallback) {
        ...
        parameters += "?userid=" + connection.userid,
            ...
            parameters += "&peerid=" + connection.sender,
            ...
            return userPreferences || (userPreferences = {}), {
                ...
                onRemoteStream: function (stream) {
                    if (connection.peers[remoteUserId] && connection.peers[remoteUserId].streams.push(stream), isPluginRTC && window.PluginRTC) {
                        var mediaElement = document.createElement("video"), body = connection.videosContainer;
    ...
    function PeerInitiator(config) {
        ...
        config.remoteSdp && config.remoteSdp.remotePeerSdpConstraints && config.remoteSdp.remotePeerSdpConstraints.isFirefoxOffered && (isFirefoxOffered = !0), localStreams.forEach(function (localStream) {
            ...
            connection.peers[self.userid] && (extra = connection.peers[self.userid].extra || extra), peer && (config.onPeerStateChanged({
                ...
                signalingState: peer.signalingState, extra: extra, userid: self.userid
    ...
    function getUserMediaHandler(options) {
        ...
        if (currentUserMediaRequest.streams[idInstance]) streaming(currentUserMediaRequest.streams[idInstance].stream, !0); else {
            if (isPluginRTC && window.PluginRTC) {
                ...
                return void window.PluginRTC.getUserMedia({audio: !0, video: !0}, function (stream) {
    ...
    var isOpera = !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0,
        ...
        isChrome = !!window.chrome && !isOpera, isIE = !!document.documentMode,
    ...
    "undefined" == typeof MediaStream && "undefined" != typeof webkitMediaStream && (MediaStream = webkitMediaStream), "undefined" != typeof MediaStream && ("getVideoTracks" in MediaStream.prototype || (MediaStream.prototype.getVideoTracks = function () {
    ...
    })), window.iOSDefaultAudioOutputDevice = window.iOSDefaultAudioOutputDevice || "speaker", function () {
        ...
        var isMobileDevice = !!/Android|webOS|iPhone|iPad|iPod|BB10|BlackBerry|IEMobile|Opera Mini|Mobile|mobile/i.test(navigator.userAgent || ""),
            ...
            isFirefox = "undefined" != typeof window.InstallTrigger,
            isSafari = Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor") > 0,
            isChrome = !!window.chrome && !isOpera, isIE = !!document.documentMode && !isEdge, isMobile = {
                Android: function () {
    ...
    var OnIceCandidateHandler = function () {
        ...
        function getTURNObj(turnStr, username, credential) {
            var urlsParam = "urls";
            "undefined" != typeof isPluginRTC && (urlsParam = "url");
            var obj = {username: username, credential: credential};
    ...
    !function (connection) {
        ...
        function beforeJoin(userPreferences, callback) {
            ...
            return session.oneway && "two-way" !== session.audio
            && "two-way" !== session.video
            && "two-way" !== session.screen ? void callback() :
                (session.oneway && session.audio && "two-way" === session.audio
                && (session = {audio: !0}),
                    void((session.audio || session.video || session.screen)
                    && (session.screen
                        ? connection.getScreenConstraints(
                            function (error, screen_constraints) {
                                connection.invokeGetUserMedia({
                                    ...
                                    ? callback : connection.invokeGetUserMedia(null, callback))
        ...
        mPeer.onGettingLocalMedia = function (stream) {
        ...
        }, connection.broadcasters = [], connection.socketOptions = {transport: "polling"},
            connection.openOrJoin = function (localUserid, password) {
                connection.checkPresence(localUserid, function (isRoomExists, roomid) {
                    ...
                    connection.userid;
                    connection.peerid = connection.userid;
            ...
            connection.userid;
            return connection.userid = connection.sessionid = localUserid ||
                ...
                isData(connection.session) ?
                    ...
                    void connection.captureUserMedia("function" == typeof isPublicModerator ? isPublicModerator : null)
        },
            ...
            connection.extra = {}, connection.attachStreams = [],
            connection.session = {
                audio: !0,
                video: !0
            },
            ...
            connection.processSdp = function (sdp) {
                return isMobileDevice || isFirefox ?
                    sdp : (sdp = CodecsHandler.setApplicationSpecificBandwidth(sdp, connection.bandwidth, !!connection.session.screen), sdp = CodecsHandler.setVideoBitrates(sdp, {
        ...
        if (connection.streamEvents = {
            ...
            navigator && navigator.connection && navigator.connection.type && (connection.isLowBandwidth = navigator.connection.type.toString().toLowerCase().search(/wifi|cell/g) !== -1, connection.isLowBandwidth)) {
