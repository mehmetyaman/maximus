...
DROP TABLE IF EXISTS maximus.translation_session_star_and_comment;
DROP TABLE IF EXISTS maximus.translation_session_invitations;
DROP TABLE IF EXISTS maximus.translator_sessions_mean_star;
DROP TABLE IF EXISTS maximus.translation_session_demands;
DROP TABLE IF EXISTS maximus.translation_session_users;
DROP TABLE IF EXISTS maximus.translation_session;
DROP TABLE IF EXISTS maximus.translator_lang;
DROP TABLE IF EXISTS maximus.sub_categories;
DROP TABLE IF EXISTS maximus.categories;
DROP TABLE IF EXISTS  maximus.users;
DROP TABLE IF EXISTS maximus.languages;


CREATE TABLE maximus.users (
...
CREATE TABLE maximus.sub_categories (
  ...
  CONSTRAINT `fk_category_id` FOREIGN KEY (`category_id`) REFERENCES maximus.categories (`id`)
    ON DELETE NO ACTION
    ON
    UPDATE NO ACTION,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)
...
CREATE TABLE maximus.translator_lang (
  ...
  CONSTRAINT `fk_translator_lang_1` FOREIGN KEY (`translator_id`) REFERENCES maximus.users (`id`)
    ON DELETE NO ACTION
    ON
    UPDATE NO ACTION,
  CONSTRAINT `fk_translator_lang_2` FOREIGN KEY (`lang_from`) REFERENCES  maximus.languages (`lang_short`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_translator_lang_3` FOREIGN KEY (`lang_to`) REFERENCES maximus.languages (`lang_short`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
...
CREATE TABLE maximus.translation_session (
  `id`            INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_translation_session_1` FOREIGN KEY (`lang1`) REFERENCES maximus.languages (`lang_short`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_translation_session_2` FOREIGN KEY (`lang2`) REFERENCES maximus.languages (`lang_short`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_translation_session_4` FOREIGN KEY (`category_id`) REFERENCES maximus.categories  (`id`)
    ON DELETE NO
    ACTION
    ON UPDATE NO ACTION
)
...
CREATE TABLE maximus.translation_session_users (
  `id`                     INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_translation_session_users_1` FOREIGN KEY (`user_id`) REFERENCES  maximus.users (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_translation_session_users_2` FOREIGN KEY (`translation_session_id`) REFERENCES maximus.translation_session (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
...
CREATE TABLE maximus.translation_session_demands (
  `id`                     INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `translation_session_id` INT(11) UNSIGNED NOT NULL,
  `user_id`                INT(11) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_translation_session_demands_1` FOREIGN KEY (`user_id`) REFERENCES maximus.users (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_translation_session_demands_2` FOREIGN KEY (`translation_session_id`) REFERENCES maximus.translation_session (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
...
CREATE TABLE maximus.translation_session_invitations (
  `id`                     INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `email`                  VARCHAR(200)     NOT NULL,
...
CREATE TABLE maximus.translation_session_star_and_comment (
  ...
  CONSTRAINT `fk_translation_session_star_and_comment_1` FOREIGN KEY (`user_id`) REFERENCES maximus.users  (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE maximus.translator_sessions_mean_star (
  ...
  CONSTRAINT `fk_translator_sessions_mean_star_1` FOREIGN KEY (`user_id`) REFERENCES maximus.users (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
